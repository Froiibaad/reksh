...
public class PanelKomb extends ImagePanel {
    ...
    public PanelKomb(Initializator init, MainFrame mf) {
    ...
    public void paint(Graphics g) {
        ...
        g.setColor(findColor(mf.Komb, 0));
        ...
        //DEC
        g.setColor(Color.GREEN);
        g.setColor(findColor(mf.Komb, 1));
        ...
        //INC
        g.setColor(Color.GREEN);
        g.setColor(findColor(mf.Komb, 2));
        ...
        //C16
        g.setColor(Color.GREEN);
        g.setColor(findColor(mf.Komb, 3));
        ...
        //X15
        g.setColor(Color.GREEN);
        g.setColor(findColor(mf.Komb, 4));
        ...
        //Y15
        g.setColor(Color.GREEN);
        g.setColor(findColor(mf.Komb, 5));
        ...
        //F15
        g.setColor(Color.GREEN);
        g.setColor(findColor(mf.Komb, 6));
        ...
        //F5
        g.setColor(Color.GREEN);
        g.setColor(findColor(mf.Komb, 12));
        ...
        //F6
        g.setColor(Color.GREEN);
        g.setColor(findColor(mf.Komb, 13));
        g.drawLine(726, 179, 751, 179);
        g.drawLine(726, 180, 751, 180);

        //F7
        g.setColor(Color.GREEN);
        g.setColor(findColor(mf.Komb, 14));
        ...
        //ADD+INC
        g.setColor(Color.GREEN);
        g.setColor(findColor(mf.Komb, 23));
        g.drawLine(210, 340, 330, 340);
        g.drawLine(210, 341, 330, 341);
       
        //C16*(ADD+INC)
        g.setColor(Color.GREEN);
        g.setColor(findColor(mf.Komb, 24));
        ...
        //ALUC
        g.setColor(Color.GREEN);
        g.setColor(findColor(mf.Komb, 25));
        ...
        //ALUZ
        g.setColor(Color.GREEN);
        g.setColor(findColor(mf.Komb, 26));
        g.drawLine(847, 218, 907, 218);     
        g.drawLine(847, 219, 907, 219);
        
        //X15*Y15*!F15
        g.setColor(Color.GREEN);
        g.setColor(findColor(mf.Komb, 27));
        ...
        //!X15*!Y15*F15
        g.setColor(Color.GREEN);
        g.setColor(findColor(mf.Komb, 28));
        ...
        //INC*!Y15*F15
        g.setColor(Color.GREEN);
        g.setColor(findColor(mf.Komb, 31));
        g.drawLine(521, 624, 650, 624);
        g.drawLine(521, 625, 650, 625);
        
        //DEC*Y15*!F15
        g.setColor(Color.GREEN);
        g.setColor(findColor(mf.Komb, 32));
        ...
        //ALUV
        g.setColor(Color.GREEN);
        g.setColor(findColor(mf.Komb, 33));
